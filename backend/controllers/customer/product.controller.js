...
// → Every active product from every active (unblocked) shop.
//   Powers Home "Recommended For You" and the Explore grid.
async function listProducts(req, res) {
  try {
    const rows = await productService.findAllPublicProducts();
