...
// POST /api/customer/orders/checkout  { cart_item_ids?: number[] }
// "Buy Now" from the Cart screen. If cart_item_ids is omitted, the whole
// bag is checked out. Prices/stock are re-checked against the DB at this
// moment (never trusted from the cart row) so a stale cart never overcharges
// or undercharges the customer.
exports.checkoutCart = async (req, res) => {
