...
class ProductModel {
  ...
  final int? productColorId; // <-- ADDED: which color the visible thumbnail belongs to
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) {
    return ProductModel(
      ...
      productColorId: json['productColorId'] != null
          ? int.tryParse(json['productColorId'].toString())
          : null, // <-- ADDED
      ...
      variants: (json['variants'] as List?)
              ...
              .toList() ??
          [],
      // UPDATED JSON PARSING for image strings
      hoverImages: (json['hoverImages'] as List?)
              ?.map((e) => e.toString())
              .toList() ??
          [],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'thumbnail': thumbnail,
      'productColorId': productColorId, // <-- ADDED
      'shopId': shopId,
      'shopName': shopName,
