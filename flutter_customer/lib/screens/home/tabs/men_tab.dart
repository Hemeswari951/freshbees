...
class _MenTabState extends State<MenTab> {
  ...
  void _onLocationChanged() {
    ...
    debugPrint('MenTab: Location changed. Reloading shops...');
  ...
  Future<void> _loadShops() async {
    ...
    try {
      ...
      debugPrint('MenTab: User latitude = $latitude');
      debugPrint('MenTab: User longitude = $longitude');
      ...
      debugPrint('MenTab._loadShops error: $e');
        ...
        Row(
          ...
          children: [
            ...
            if (_shops.length > 5)
              TextButton(
                onPressed: () {
                  context.push('/shops?category=Men');
                },
