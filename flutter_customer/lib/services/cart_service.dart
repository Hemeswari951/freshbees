...
class CartService {
  ...
  /// POST /api/customer/orders/checkout  { cart_item_ids? }
  /// "Buy Now" from the Cart screen. Pass specific [cartItemIds] to check
  /// out only some of the bag, or leave null to check out everything.
  static Future<void> checkout({List<int>? cartItemIds}) async {
    final response = await http.post(
