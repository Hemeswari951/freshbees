    ...
    if (_error != null) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            Text(_error!, style: TextStyle(color: TColors.ink.withOpacity(0.6))),
        ...
        Column(
          children: [
            Text(
              ...
              style: const TextStyle(fontSize: 32, fontWeight: FontWeight.w800, color: TColors.ink),
            ),
            Row(
            ...
            Text(
              ...
              style: TextStyle(fontSize: 11, color: TColors.ink.withOpacity(0.5)),
            ),
          ],
        ),
          ...
          child: Column(
            children: [5, 4, 3, 2, 1].map((star) {
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    Text('$star', style: const TextStyle(fontSize: 11, color: TColors.ink)),
                    const SizedBox(width: 4),
                    const Icon(Icons.star_rounded, size: 11, color: TColors.gold),
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        '$percent%',
                        style: TextStyle(fontSize: 10.5, color: TColors.ink.withOpacity(0.5)),
                      ),
                    ),
                  ],
                ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: Text(
                  ...
                  style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: TColors.ink),
                ),
              ),
              Row(
                children: List.generate(
          ...
          const SizedBox(height: 2),
          Text(date, style: TextStyle(fontSize: 10.5, color: TColors.ink.withOpacity(0.4))),
          if (r.reviewText.isNotEmpty) ...[
            const SizedBox(height: 6),
            Text(r.reviewText, style: const TextStyle(fontSize: 12.5, color: TColors.ink, height: 1.4)),
          ],
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: TColors.ink),
          ),
